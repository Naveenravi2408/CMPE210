...
class switch_13_im(app_manager.RyuApp):
	#using protocol v1.3 of openflow
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]
    #using args and kwargs to denaote some unspecified variabes to go in as input into the switch_13_im class
    def __init__(self, *args, **kwargs):
        super(switch_13_im, self).__init__(*args, **kwargs)
        self.mac_to_port = {}
    ...
    def switch_handler_rules(self, ev):
        ...
        actions = [parser.OFPActionOutput(ofproto.OFPCML_NO_BUFFER,ofproto.OFPP_CONTROLLER)]
...
#References
# 1) Ryu documentation
# 2) Simple_switch13.py under ryu examples
# 3) Ofctl_ryu.py under ryu ofctl
# 4) Ryu postman integration article from Postman tool